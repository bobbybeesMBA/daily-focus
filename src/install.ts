...
async function main() {
  ...
  try {
    ...
    printSuccess(`.env file saved to: ${envPath}`);
    print();
    ...
    printBullet(`Your ${c.green}.env${c.reset} file has been created automatically!`);
    printBullet(`Test locally: ${c.cyan}npm start${c.reset}`);
    printBullet('Add the secrets above to GitHub for scheduled runs');
    print();
